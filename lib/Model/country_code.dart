class CountryCodeData {
  ...
  String dialCode;
  CountryCodeData(
      {required this.code, required this.dialCode, required this.name});

  factory CountryCodeData.fromJson(Map json) => CountryCodeData(
      code: json['code'], dialCode: json['dial_code'], name: json['name']);
}


List<Map> countryCodeJson = [
...
List<CountryCodeData> countryCodes=countryCodeJson.map((e) => CountryCodeData.fromJson(e)).toList();